...
>) {
  ...
  return (
    ...
    >
      <div
        className={cn(
          "w-auto text-white z-10 bg-black bg-opacity-50 px-4 py-2 rounded-[inherit]",
          className
        )}
      >
        {children}
      ...
      />
      <div className="bg-black bg-opacity-50 absolute z-1 flex-none inset-[2px] rounded-[100px]" />
    </Tag>
  );
}
